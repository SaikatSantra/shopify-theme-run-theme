...
class FilterDrawerButton extends HTMLElement {
  constructor() {
    super();
    this.addEventListener("click", (event) => {
      const filterDrawer = this.closest(".collection-wrapper").querySelector(
        "collection-filters-form"
      );
      let buttonText = this.querySelector(".filter-text");
...
customElements.define("filter-drawer-button", FilterDrawerButton);
