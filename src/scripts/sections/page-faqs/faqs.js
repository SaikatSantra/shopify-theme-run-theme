export const initFaqs = () => {
  ...
  class FAQsToggles {
    constructor() {
      ...
      // Mobile
      this.toggleListMobile = document.querySelectorAll(
        "[data-faqs-mobile-nav-item]",
      );
    ...
    show(e) {
      ...
      const content = document.querySelector(
        '[data-faqs-category][data-index="' + index + '"]',
      );
    ...
    showMobile() {
      ...
      const button = document.querySelector(
        '[data-faqs-toggle][data-index="' + index + '"]',
      );
      const content = document.querySelector(
        '[data-faqs-category][data-index="' + index + '"]',
      );
    ...
    hide() {
      for (let i = 0; i < this.toggleList.length; i++) {
        ...
        this.toggleListMobile[i].classList.remove(
          "faqs__navigation-button--current",
        );
