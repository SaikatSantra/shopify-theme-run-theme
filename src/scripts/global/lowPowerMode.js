...
const forceYouTubeVideoPlay = (e) => {
  ...
  let nearestVideo = target
    .closest(".shopify-section")
    .querySelector(".video-container--single[data-yt-video]");
  const desktopVideo = target
    .closest(".shopify-section")
    .querySelector(".video-container--desktop[data-yt-video]");
  const mobileVideo = target
    .closest(".shopify-section")
    .querySelector(".video-container--mobile[data-yt-video]");
