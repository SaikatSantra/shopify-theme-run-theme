...
const Star: React.FunctionComponent<IRatingStar> = ({colour}) => {
  return (
    <svg width="22" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M11 16.074 17.798 20l-1.804-7.4L22 7.621l-7.909-.653L11 0 7.909 6.968 0 7.621 5.995 12.6 4.202 20 11 16.074Z" fill={colour} />
    </svg>
  )
}
...
const RatingFilter: React.FunctionComponent<IRatingFilter> = ({ option }) => {
  ...
  return (
    <div className='filter__rating'>
      ...
      {!isNaN(option.records) && <span className='filter__count filter__count--rating'>({option.records})</span>}
    </div>
  )
}
