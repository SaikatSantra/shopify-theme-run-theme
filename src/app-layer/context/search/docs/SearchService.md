...
The Shopify service is enabled by default. It uses JSON data templates returned by Liquid for the data. Search for _.sf-data.liquid and sf-_.liquid to find these.
