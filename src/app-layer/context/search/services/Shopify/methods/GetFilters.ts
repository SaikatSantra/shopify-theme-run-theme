import { IActiveCollection, IGetFiltersResult, ISearchFilter } from '../../../types';
...
const GetFilters = async (activeCollection: IActiveCollection): Promise<IGetFiltersResult> => {
  ...
  try {
    const templateData = await getTemplateJSON<ICollTemplateResponse>('collections', collHandle, 'sf-data');
